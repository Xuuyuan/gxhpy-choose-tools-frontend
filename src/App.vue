<template>
  <el-container class="app-shell">
            ...
            <el-col :span="24" :lg="7">
              <el-card header="1. 基本筛选条件" class="panel-card filter-card">
                <el-form :model="filters" label-position="top">
                  ...
                  <el-row :gutter="20">
                    ...
                    <el-col :span="24" :md="12">
                      <el-form-item label="最高报录比 (已选/容量)">
                        ...
                        <el-input-number v-model="filters.maxRatio" :disabled="filters.excludeFullCourses" :min="0" :max="20" :step="0.1" controls-position="right" style="width: 100%;" />
                      </el-form-item>
                    </el-col>
                  </el-row>
                  ...
                  <el-form-item>
                    <el-checkbox v-model="filters.excludeFullCourses">[排除] 已满员课程（第二、三阶段使用）</el-checkbox>
                  </el-form-item>
              ...
              <el-card header="2. 选课方案模板" class="panel-card template-card">
                <div class="preferences-toolbar">
                  <small v-if="preferencesError" role="status">{{ preferencesError }}</small>
    ...
    <el-footer class="app-footer">
      <el-text><el-link href="https://github.com/Xuuyuan" target="_blank">@Xuuyuan Generated by Gemini &amp; ChatGPT</el-link> | <el-link href="https://github.com/Xuuyuan/gxhpy-choose-tools-frontend" target="_blank">GitHub</el-link></el-text>
    </el-footer>
  </el-container>
</template>
...
watch(() => filters.excludeFullCourses, (excludeFullCourses) => {
  if (excludeFullCourses) filters.maxRatio = 0.9999;
...
const filteredCourses = computed(() => {
  ...
  return processedCourses.value.filter(course => {
    if (filters.excludeFullCourses && course.yxrs >= course.jxbrl) return false;
...
.preferences-toolbar > .el-button { margin-left: auto; }
